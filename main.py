...
def sidebar():
    ...
    # frequencyType = st.sidebar.radio('Frequency Type', ['Hz', 'FMAX'], key='frequencyType')
    # if frequencyType == 'Hz':
    #     frequency = st.sidebar.slider('Frequency', 1, 100, 1, key='frequency', on_change=updateSignal)
    # else:
